...
class Drawing:
    ...
    def fps(self, clock):
        ...
        render = self.font.render(display_fps, 0, FPSGREEN)
    ...
    def menu(self):
        ...
        label_font = pygame.font.Font('font/font1.otf', 270)
        ...
        while self.menu_trigger:
            ...
            color = randrange(40)
            label = label_font.render('ZOMSTRIKE', 1, (color, color, color))
            self.sc.blit(label, (15, 0))
